# sewing-machine-digital-twin
Real-time sewing machine digital twin with FastAPI,Flutter, and ML efficiency prediction for apparel manufacturing (Industry 4.0)
